...
export default class ActivityType {
    ...
    static async seed() {
        //                    subCategory                   category    price     providerPrices                          Description                      Instructions
        const activityTypes = [
            ...
            new ActivityType("private-half-day-for-1-to-4",  "tour",      500000,  { "dewa"  : 350000,  "rena" : 400000 }, "Duration: 4 hours",             "Check if customer needs vegan breakfast" ),
            new ActivityType("private-half-day-for-5-to-6",  "tour",      600000,  { "rena"  : 400000                   }, "Duration: 4 hours",             "Check if customer needs vegan breakfast" ),
            new ActivityType("private-full-day-for-1-to-4",  "tour",      950000,  { "dewa"  : 600000,  "rena" : 750000 }, "Duration: 8 hours",             "Check if customer needs vegan breakfast" ),
            new ActivityType("private-full-day-for-5-to-6",  "tour",      600000,  { "rena"  : 750000                   }, "Duration: 8 hours",             "Check if customer needs vegan breakfast" ),
            new ActivityType("rice-paddy-waterfall-village", "tour",      0,       {},                                     "Duration: 1 hour",              ""                                        ),
            new ActivityType("custom",                       "custom",    0,       {},                                     "",                              ""                                        ),
        ];
