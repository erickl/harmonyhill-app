...
export default class ActivityType {
    ...
    constructor(subCategory, category, priority, customerPrice, providerPrices, houseAvailability, description, instructions, isCustom = false) {
    ...
    static async seed() {
        ...
        const activityTypes = [
            ...
            new ActivityType("custom",                        "transport",  100, 0,       {                                    }, ["harmony hill", "the jungle nook"], "",                                                                                  ""                                                                , true ), // todo: double check price
            ...
            new ActivityType("private-full-day-for-5-to-6",   "tour",       100, 1100000, { "rena"  : 750000                   }, ["harmony hill"                   ], "Duration: 8 hours",                                                                 "Check if customer needs vegan breakfast"                                ),
            ...
            new ActivityType("custom",                        "custom",     999, 0,       {                                    }, ["harmony hill", "the jungle nook"], "",                                                                                  ""                                                                , true ),
        ];
