...
export default class Inventory {
    ...
    static async seed() {
        const inventoryItems = [         
            ...
            new Inventory("Candle",                                "minibar",           90000,    0,               [],                null),
            new Inventory("Umbrella",                              "minibar",           0,        0,               [],                null),

            new Inventory("Peanut Butter Chocolate Cookie",        "dessert",           35000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/peanut-butter-cookie.png"     ), 
            new Inventory("Chocolate Chip Cookie",                 "dessert",           35000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/chocolate-chip-cookie.png"    ), 
            new Inventory("Brookies (2 pcs)",                      "dessert",           60000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/brookies.png"                 ), 
            new Inventory("Cookies And Cream Cake",                "dessert",           60000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/cookies-and-cream-cake.png"   ), 
            new Inventory("Chocolate Caramel Cake",                "dessert",           60000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/chocolate-caramel-cake.png"   ), 
            new Inventory("Mango Coconut Cheese Cake",             "dessert",           60000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/mango-coconut-cheese-cake.png"), 
            new Inventory("Forest Berry Cheese Cake",              "dessert",           60000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/forest-berry-cheesecake.png"  ), 
            new Inventory("Biscoff Caramel Peanut Slice (Square)", "dessert",           50000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/biscoff-slice.png"            ), 
            new Inventory("Biscoff Cheesecake (Round)",            "dessert",           60000,    0,               [],                "gs://harmonyhill-1.firebasestorage.app/resources/menu/biscoff-cheesecake-round.png" ), 
        ];
