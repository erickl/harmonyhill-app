...
export default class Inventory {
    ...
    static async seed() {
        const inventoryItems = [         
            ...
            new Inventory("Brookies"        ,                      "dessert",           35000,    0,               [],                {"hh" : 0,  "jn": 0}               ,"gs://harmonyhill-1.firebasestorage.app/resources/menu/brookies.png"                 ), 
            new Inventory("Matcha Cookie"        ,                 "dessert",           40000,    0,               [],                {"hh" : 0,  "jn": 0}               ,null                                                                                 ), 
