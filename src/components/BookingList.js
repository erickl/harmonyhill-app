...
export default function BookingList({ onNavigate, title, filter, expand}) {
    ...
    const handleCustomerClick = (customer) => {
        const newExpandedBookings = utils.deepCopy(expandedBookings);
        const expand = !utils.exists(newExpandedBookings, customer.id);
    ...
    }, [customerToEdit, sectionIsExpanded]);
